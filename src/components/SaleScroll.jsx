...
function SaleCardScroll() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:3000/product?page=1&onlySales=true&pageSize=75`
        );
  ...
  return (
    <div className="w-full h-auto mt-12 flex justify-center items-center flex-col relative">
      <h1 className="text-left w-[80%] text-xl font-bold mb-4">
        {t("SaleProduct")}
      </h1>
      <div
        className="relative w-full max-w-[90%] h-[65vh] overflow-x-hidden overflow-y-hidden"
                  ...
                  >
                    ...
                    <div className="w-full h-auto pl-2 flex flex-col justify-start items-start gap-3 mt-3">
                      <div className="w-[100%] h-[auto] flex justify-start items-center">
                        <h1 className="w-[150px] h-[27px] rounded-xl flex justify-center items-center text-white text-xs font-semibold bg-orange-400">
                          საგაზაფხულო ფასი
                        </h1>
                      </div>
                      ...
                      <div className="w-[auto] h-[auto] flex justify-start items-start gap-2">
                        <h1 className="text-md text-orange-500 font-bold">
                          {product.salePrice} ₾
                        </h1>
                        <h1 className="text-md text-black dark:text-white line-through">
                          {product.price} ₾
                        </h1>
                      </div>
                    </div>
